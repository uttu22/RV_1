module imm_logic  (
    ...
    always_comb begin : imm_logic
        case(opcode)
            ...
            OP_U_AIUPC  : imm = {inst[31:12] , 12'b0} ,
            ...
            OP_I_ARITH  : imm = {21{inst[31]} ,inst[30:20]},
            OP_I_SHIFT  : imm = {21{inst[31]} ,inst[30:20]},
            OP_B_BRANCH : imm = {20{inst[31]} , inst[7] , inst[30:25] , inst[11:8] , 1'b0},
            OP_S_STORE  : imm = {21{inst[31]} , inst[30:25] , inst[11:8] , inst[78]}
        endcase 
    end
